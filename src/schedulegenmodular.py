...
def checkfitness_and_calculate_makespan (parent_list,offspring_list,population_size, num_flows,num_links, process_time, flow_sequence):
...
def traffic_schedule(data_dict, population_size=30, crossover_rate=0.8, mutation_rate=0.2, mutation_selection_rate=0.2,
    ...
    for iteration in range(num_iteration):
        ...
        total_fitness, chrom_fitness, chrom_fit, total_chromosome , makespan = checkfitness_and_calculate_makespan(parent_list,offspring_list,population_size, num_flows,num_links, process_time, flow_sequence)
